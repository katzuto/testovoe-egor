...
var updateIds = function updateIds(selectedMap) {
  var selectedIdsList = document.getElementById('selectedIds');
...
var updateUrl = function updateUrl(selectedMap) {
  var selectedCheckboxes = Array.from(selectedMap).filter(function (_ref) {
...
var getCheckboxes = function getCheckboxes(checkboxes, selectedMap) {
...
//# sourceMappingURL=/test-BFT.e31bb0bc.js.map